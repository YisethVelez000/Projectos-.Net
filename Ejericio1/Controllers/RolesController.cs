...
namespace Ejericio1.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(Ejercicio1Context context)
        {
            _context = context;
        }
        ...
        {
            // Apply search logic if searchString is provided
            IQueryable<Role> roles = _context.Roles;
            if (!String.IsNullOrEmpty(searchString))
            {
                roles = roles.Where(r => r.NombreRol.Contains(searchString));
            }
        ...
        //Creamos una funcion de busqueda 
        // GET: Roles
